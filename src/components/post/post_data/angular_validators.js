...
module.exports = function(props) {
  return (
    <div>
      ...
      that can be used to create your custom field validations.</p>
      <p> This can be accessed in the link function and set for the field you would like to validate.
      <code data-gist-id="f71e72bc81f7382843f099afba677164" data-gist-show-spinner="true"></code></p>
      <p> What if you needed to make that call to the server to validate? You would use <code>asyncValidators</code>.
      <code data-gist-id="d5b9d402e7a2d9ab88853e1c78e5b5cb" data-gist-show-spinner="true"></code></p>
      ...
      to update the behavior of the validation.</p>
      <p> These can be set on the field:
      <code data-gist-id="638367bd374f55b9d8f372aa697d2e71" data-gist-show-spinner="true"></code></p>
      ...
      with validation errors and we make fewer calls to the server for validation.</p>
      <p> These can also be added in the link function.
      <code data-gist-id="bfcdee582b2bad79452679f7a9b6988e" data-gist-show-spinner="true"></code></p>
      ...
      <code data-gist-id="900ff593b3ca2d74443b1c2f54d10a2b" data-gist-show-spinner="true"></code></p>
      ...
      We will discuss the different functions provided by Angular in a future post.</p>
      ...
      That can all be done by adding them to the appropriate property on <code>NgModelController</code>.</p>
